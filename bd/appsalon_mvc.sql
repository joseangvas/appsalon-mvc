...
-- Volcando datos para la tabla appsalon_mvc.citas: ~9 rows (aproximadamente)
...
-- Volcando datos para la tabla appsalon_mvc.citasservicios: ~25 rows (aproximadamente)
...
-- Volcando datos para la tabla appsalon_mvc.servicios: ~9 rows (aproximadamente)
...
-- Volcando datos para la tabla appsalon_mvc.usuarios: ~2 rows (aproximadamente)
